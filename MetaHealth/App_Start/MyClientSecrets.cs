...
namespace Calendar.ASP.NET.MVC5
{
    ...
    {
        public const string ClientId = "180774585516-7nm3okoofj8am2efsvvdom563vdu056i.apps.googleusercontent.com";
        public const string ClientSecret = "oujTGlZd2YcSU3wEAc_xReUV";
    }
}